...
TEST(IntToString, intToStringTest)
{
    char testNum[100];
    int numberOutput;
    char *testNumString[] = {"333", "3454345", "12323", "9999123", "12309312"};
    char testNumLength[5] = {3, 7, 5, 7, 8};
    int testNumList[5] = {333, 3454345, 12323, 9999123, 12309312};

    for (int i = 0; i < 5; ++i)
    {
        intToString(testNumList[i], testNum, testNumLength[i]);
        EXPECT_TRUE(strcmp(testNum, testNumString[i]) == 0);
        printf("\n %s \n", testNum);
    }
}
