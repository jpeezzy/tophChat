...
#define PACKAGE_SIZE 512      // total package size including null terminator
#define CHAT_ROOM_LIMIT 5    // a user can have maximum of 20 rooms open
...
#define MAX_USER_FRIEND 10 // max number of friend a user can have
